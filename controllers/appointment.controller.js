...
const deleteAppointment = async (req = request, res = response) => {
    ...
    try {
        ...
        return res
            .status(200)
            .json(success('ok', { appointment }, res.statusCode))
    } catch (ex) {
...
const getAllAppointments = async (_, res = response) => {
...
const confirmAppointment = async (req = request, res = response) => {
    ...
    if (!appointment) {
        return res
            ...
            .json(
                error(
                    'La reseva no existe, o ya ha sido confirmada',
                    res.statusCode
                )
            )
    }
...
const completeAppointment = async (req = request, res = response) => {
    ...
    if (!appointment) {
        return res
            ...
            .json(
                error(
                    'La reseva no existe, o ya ha sido completada',
                    res.statusCode
                )
            )
    }
...
const getNextAppointment = async (req = request, res = response) => {
    ...
    if (isEmpty(appointment)) {
        return res
            .status(201)
            .json(success('No hay reservas', {}, res.statusCode))
    }
