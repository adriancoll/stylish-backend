...
router.post(
    ...
    [
        ...
        check(
            'employees',
            'El número de empleados es obligatorio.'
        ).isNumeric(),
        check('name', 'El nombre es obligatorio.').not().isEmpty(),
        check(
            'description',
            'La decripción es obligatoria, pero puede ser muy breve.'
        )
            .not()
            .isEmpty(),
...
router.post(
    ...
    [
        ...
        check(
            'id',
            'No existe el negocio que estás intentandon editar.'
        ).custom(businessExists),
